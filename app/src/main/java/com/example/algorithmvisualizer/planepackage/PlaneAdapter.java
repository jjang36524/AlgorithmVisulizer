...
public class PlaneAdapter extends MyAdapter{
    public PlaneAdapter(ArrayList<ListItem> items, Context applicationContext) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    case 0:
                        intent = new Intent(mContext, ConvexhullActivity.class);
                        break;
                    case 1:
                        intent = new Intent(mContext, RotatingCalipusActivity.class);
                        break;
                    case 2:
                        intent = new Intent(mContext, MinCircleActivity.class);
                        break;
                    default:

...
public class DequeActivity extends Activity {
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String[] querylist=getResources().getStringArray(R.array.dequequery);
        ...
        CList<Integer> li=new CList<>(stack, Arrays.asList(0,0,0,1,0,0,0));
            ...
            public void onClick(View view) {
                ...
                switch(qp[0])
                {
                    case 0:
                        ...
                        if((top[1] +1)%7==top[0])
                        {
                            Toast t=Toast.makeText(getApplicationContext(), "deque is full", Toast.LENGTH_SHORT);
                            t.show();
                            break;
                        }
                        top[0]+=6;
                        ...
                        break;
                    case 1:
                        v=Integer.parseInt(t.getText().toString());
                        if(v<=0)
                        {
                            Toast t=Toast.makeText(getApplicationContext(), "invalid index or value", Toast.LENGTH_SHORT);
                            t.show();
                    ...
                    case 5:
                        if(top[0]==top[1])
                        {
                            t=Toast.makeText(getApplicationContext(), "queue is empty", Toast.LENGTH_SHORT);
                            t.show();
                            break;
                        }
                        t=Toast.makeText(getApplicationContext(), "back element is "+li.get((top[1]+6)%7), Toast.LENGTH_SHORT);
                        t.show();
                        break;
                    case 6:
